...
- [done] Step 0 is to link `src/index.js` to the `src/index.html` file using a script tag.
- [done] Steps 1 and 2 are explained inside the `src/components/header.js` file.
- [done] Steps 3 and 4 are explained inside the `src/components/tabs.js` file.
- [done] Steps 5 and 6 are explained inside the `src/components/card.js` file.
